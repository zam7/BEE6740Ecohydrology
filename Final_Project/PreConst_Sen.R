...
MetData <- read.csv("final_pre_metdata.csv")
...
###### Analyze period before construction of mall (1990-1993) 
####################################################################################
...
NS_HSR_obs = get_usgs_gage(flowgage_id = "01376800", begin_date = "1990-01-01", end_date="1993-12-30")
####################################################################################
