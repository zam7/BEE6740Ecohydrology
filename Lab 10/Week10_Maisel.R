...
#Step 2: We're going to consider climate transferability of hydrologic model parameters by calibrating our model to four years with drastically different
# climate conditions. Edit the data selection to include the year of interest and one or two "spin-up" years, this code can be run four times. 
